...
- **หน้า "บริการ" จัดวางใหม่ทั้งหน้า (Services Page Redesign):** เมื่อก่อนหน้าบริการเป็นการ์ดเรียงเดียวกันหมด
  ...
  เลื่อนโชว์รูปอัตโนมัติทุก 5 วินาทีพร้อมแถบไล่สีบอกความคืบหน้า วนกลับไปเริ่มใหม่เมื่อถึงใบสุดท้าย และบริการอื่นๆ
  (เช่าห้องประชุม, แปลเอกสาร ฯลฯ) จัดเป็นตารางการ์ดสูงเท่ากันทุกใบ ไม่มีไอคอนล้นขอบอีกต่อไป
- **เมนูลอยติดจอเวลาเลื่อนอ่าน (Sticky Header):** เมื่อก่อนเลื่อนอ่านเนื้อหายาว ๆ แล้วต้องเลื่อนกลับขึ้นบนสุดทุกครั้ง
  ถ้าอยากกดเมนูหรือปุ่มจองผ่าน LINE ตอนนี้แถบเมนูด้านบนลอยติดจอตลอดเวลา กดได้ทุกจุดที่กำลังอ่านอยู่ ไม่ต้องเลื่อน
  กลับ ส่วนความกว้างของการ์ดในหน้าแรกก็ปรับให้โปร่งขึ้น ไม่อึดอัดเหมือนก่อน โดยที่โลโก้กับปุ่มจองยังอยู่ตำแหน่งเดิม
  ไม่ขยับ
- **เลื่อนดูรูปและรีวิวแบบสไลด์ได้แล้ว (Gallery & Review Carousels):** หน้ารายละเอียดคอร์ส/โปรโมชั่น/เวิร์กช็อป
  แท็บ "รูป" กับ "รีวิว" เมื่อก่อนเรียงยาวเป็นตับต้องเลื่อนลงเรื่อย ๆ ตอนนี้เปลี่ยนเป็นเลื่อนซ้าย-ขวาแบบสไลด์
  พร้อมปุ่มลูกศรและจุดบอกตำแหน่ง กดหรือปัดก็ได้
- **คอร์ส/เวิร์กช็อปที่อยากให้เด่นแยกออกจากใบอื่นชัดเจน (Featured Tiles + Quick-View):** หน้ารวมคอร์สและ
  เวิร์กช็อปตอนนี้เลือกได้ว่าใบไหนอยากให้ "เด่น" กว่าใบอื่น (กว้างเป็น 2 เท่าของใบปกติ) แล้วเติมป้ายกำกับเองได้
  จากหน้าจัดการเนื้อหา เช่น "ขายดี" หรือ "แนะนำ" ใบที่เด่นจะมีปุ่ม "+" กดแล้วเปิดดูรายละเอียดแบบหน้าต่างเล็ก
  (popup) ได้ทันที ไม่ต้องเปลี่ยนหน้า เหมือนเปิดหน้าใหม่แต่ไม่ต้องเสียตำแหน่งที่เลื่อนดูอยู่
- **ค้นหาและกรองคอร์ส/บริการได้แล้ว (Search & Filter):** หน้า "คอร์สเรียน" และ "บริการ" เมื่อก่อนต้องไล่เลื่อนดู
  ทีละใบเอง ตอนนี้มีช่องค้นหาพิมพ์ชื่อคอร์สได้ทันที บวกปุ่ม "ตัวกรอง" ให้เลือกวิชา/ชั้นปี/หมวดหมู่ที่ต้องการ
  ผลลัพธ์กรองให้ทันทีโดยไม่ต้องโหลดหน้าใหม่
